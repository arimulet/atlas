...
export type SokkerMatchSummary = SokkerMatchSummaryDto;
export type SokkerMatchPlayerStats = SokkerMatchPlayerStatsDto;
export type SokkerLeagueInfo = SokkerLeagueDto;

export function parseSokkerMatchesXml(xml: string): SokkerMatchSummaryDto[] {
...
export function parseSokkerMatchDetailXml(
  xml: string,
  clubId: number
): SokkerMatchPlayerStatsDto[] {
...
export function parseSokkerLeagueXml(xml: string): SokkerLeagueDto {
