...
export function SokkerImporterForm({
  ...
  return (
    <form className="atlas-v2-sokker-importer" onSubmit={handleSubmit}>
      <div className="atlas-v2-sokker-importer__fields">
        <div className="atlas-v2-sokker-importer__field">
          <label htmlFor="atlas-v2-sokker-login">Usuario</label>
          <input
            id="atlas-v2-sokker-login"
            type="text"
            name="login"
        ...
        <div className="atlas-v2-sokker-importer__field">
          <label htmlFor="atlas-v2-sokker-password">Contraseña</label>
          <input
            id="atlas-v2-sokker-password"
            type="password"
            name="password"
      ...
      {feedback ? (
        <div
          className={`atlas-v2-sokker-importer__feedback is-${feedback.kind}`}
      ...
      <div className="atlas-v2-sokker-importer__actions">
        <button
          type="button"
          className="atlas-v2-button atlas-v2-button--secondary"
          onClick={onCancel}
          disabled={isLoading}
        >
          Cancelar
        ...
        <button
          type="submit"
          className="atlas-v2-button atlas-v2-button--primary"
          disabled={!canSubmit}
        >
          {isLoading ? (
            <>
              <span className="atlas-v2-spinner" aria-hidden="true" />
              Actualizando...
            </>
          ) : (
            "Actualizar"
